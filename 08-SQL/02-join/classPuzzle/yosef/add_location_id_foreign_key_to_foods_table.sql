...
-- alter table foods
-- add column location_id foreign key(location_id) references storage_locations(location_id) on delete cascade;
...
insert into foods (food_name, food_type, kosher,location_id) values
("eggs","vegtable",true,1);
